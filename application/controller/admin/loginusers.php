        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
              ...
              <div class="input-group no-border">
                <input type="text" name="search_text" id="search_text" placeholder="Login User" class="form-control" />
         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">REMOVE Users</p>
               </div>
               <div class="card-body">
...
$(document).ready(function(){
    ...
    {
        $.ajax({
            url:"https://myprojectspi.ga/application/controller/admin-function/userfetch",
            method:"post",
            data:{query:query},
